...
const faqData: FAQItem[] = [
  ...
  {
    id: 'faq-4',
    question: 'IP人設規劃和一鍵生成有什麼不同？',
    answer: 'IP人設規劃是對話式 AI 顧問，適合深度規劃帳號定位、內容策略和 14 天規劃。一鍵生成是快速生成工具，三步驟即可產出腳本，適合快速產出內容。建議先用 IP人設規劃建立定位，再用一鍵生成快速生成。',
    category: 'features',
    tags: ['IP人設規劃', '一鍵生成', '功能']
  },
  {
  ...
  },
  {
    ...
    answer: '建議：1) 在 IP人設規劃中更詳細地描述您的需求。2) 調整「個人資料」中的 AI 偏好設定（語氣、語言、主題）。3) 使用「創作者資料庫」中的編輯功能手動調整。4) 多次嘗試，AI 會根據您的反饋改進。',
    category: 'technical',
    tags: ['生成', '優化']
  },
  // 帳號問題
